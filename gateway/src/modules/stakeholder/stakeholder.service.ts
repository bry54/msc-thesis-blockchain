...
export class StakeholderService extends TypeOrmCrudService<Stakeholder> {
  ...
  async createOne(
    ...
    await this.blockchainService.createOne(res);
    return res;
  }
  ...
  async updateOne(
    ...
    await this.blockchainService.updateOne(res.id, dto);
    return res;
  }
  ...
  async deleteOne(req: CrudRequest): Promise<void | Stakeholder> {
    ...
    await this.blockchainService.updateOne(id, { deletedDate: rec.deletedDate });
    return res;
  }
}
