...
export const UpdatePricingDetails = ({ product }) =>{
    ...
    const queryRecords = async () =>{
        const response = await axios.get(`${API_HOST}/pricing-details/${product.id}`, reqConfigs)
    ...
    const patchRec = async () => {
        await axios.patch(`${API_HOST}/pricing-details/${product.id}/update/${selectedRec.id}`, selectedRec, reqConfigs)
        queryRecords();
    }

    const deleteRec = async () => {
        await axios.delete(`${API_HOST}/pricing-details/${product.id}/delete/${selectedRec.id}`, reqConfigs)
        queryRecords();
    }

    const createRec = async () => {
        await axios.post(`${API_HOST}/pricing-details/${product.id}/create`, selectedRec, reqConfigs)
        queryRecords();
    }
